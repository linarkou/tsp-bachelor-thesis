...
<div class="container">
    ...
    <c:if test="${canCreate == true}"> 
        <a href="${contextPath}/driver/registration">Добавить нового водителя</a>
    </c:if>
    <c:if test="${canCreate == false}"> 
        Для того, чтобы добавить водителя, необходимо добавить хотя бы один <a href="${contextPath}/admin/stocks">склад.</a>
    </c:if>
    

    <h4>Текущие водители: </h4>
